...
One thing that could further strengthen this analysis is a brief discussion of the identifying assumption behind the difference-in-differences approach. In particular, the method relies on the idea that employment trends in New Jersey and Pennsylvania would have followed a similar path in the absence of the policy change.

Making this assumption more explicit could help readers better understand why the comparison between the two states can be interpreted as a causal effect, rather than just a simple difference in outcomes.